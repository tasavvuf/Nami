  ...
  return (
    <div className="mx-auto grid max-w-6xl items-start gap-8 lg:grid-cols-[0.9fr_1.1fr]">
      <section className="max-w-xl">
        ...
        <p className="mt-5 text-base font-medium leading-8 text-slate-100/75">
         It won't go to them. But it'll go somewhere. And that's enough.
        remeber, for us you matters buddy
        </p>
      </section>
      ...
      >
        <div className="glass-card-inner relative overflow-hidden rounded-[1.95rem] p-5 sm:p-7">
          ...
          <textarea
            ...
            rows={8}
            className="relative mt-4 min-h-48 w-full resize-y rounded-[1.35rem] border border-white/15 bg-slate-950/25 px-5 py-4 text-base font-semibold leading-8 text-white/95 shadow-inner shadow-black/15 outline-none backdrop-blur-xl transition placeholder:text-slate-200/45 focus:border-cyan-100/55 focus:ring-2 focus:ring-cyan-100/70"
          />
          ...
          <div className="relative mt-6">
            ...
            <input
              ...
              className="mt-4 w-full rounded-[1.35rem] border border-white/15 bg-slate-950/25 px-5 py-3 text-base font-semibold text-white/95 shadow-inner shadow-black/15 outline-none backdrop-blur-xl transition placeholder:text-slate-200/45 focus:border-cyan-100/55 focus:ring-2 focus:ring-cyan-100/70"
            />
              ...
              {predefinedTags.map((suggestion) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-full border px-3 py-2 text-xs font-bold transition focus:outline-none focus:ring-2 focus:ring-cyan-100/80 ${
                      isSelected
